...
try:
    ...
    print(f"[FieldPassPDF] ReportLab import note: {_rl_err}")
    HAS_REPORTLAB = False
...
def generate_field_pass_pdf(traveler_data: dict = None) -> bytes:
    ...
    if not HAS_REPORTLAB:
        # Ultra-resilient raw PDF fallback ensuring zero-crash on serverless environments
        fallback_text = (
            ...
            b"BT /F1 14 Tf 50 780 Td (BHARAT EXPLORE - HIMALAYAN TRAVEL SAFETY & DANGER GUIDELINES) Tj "
            b"0 -30 Td (Emergency Distress Hotline: 112 / Tourist Helpline: 1363 / SNM Hospital: +91-1982-252014) Tj ET\n"
            b"endstream\nendobj\nxref\n0 5\n0000000000 65535 f \n0000000009 00000 n \n0000000058 00000 n \n"
