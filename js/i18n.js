...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      map_sub: "Interactive spatial discovery powered by Leaflet.js. Hover over any pulse node to preview its live telemetry card, or click to inspect and plan tour routes.",
      ...
      map_panel_desc: "Hover over any pulse marker on the map to preview interactive cards, or click to inspect full regional telemetry and connect immediately to the Smart Tour Planner.",
      ...
      ai_title: "Your intelligent pan-India travel companion.",
      ai_sub: "Real-time conversational intelligence for all of Bharat — from Kolkata's heritage to Rajasthan's forts, Kerala's backwaters, and Himalayan mountain passes.",
      sug_kolkata: "Kolkata Heritage",
      sug_jaipur: "Jaipur Highlights",
      ...
      ai_bot_status: "Bharat AI • Active",
      ai_welcome: "Namaste! 🙏 I am Bharat AI, your intelligent travel companion for all of India. Ask me about Kolkata, Rajasthan, Kerala, the Himalayas, local cuisine, sustainable homestays, or custom tour plans!",
      ai_input_placeholder: "Ask Bharat AI about destinations, routes, food, culture...",
      ai_send: "Send →",

      // Planner
      plan_eyebrow: "SMART TOUR PLANNER",
      plan_title: "Turn days into lifelong memories.",
      plan_sub: "AI-audited tour planner factoring in live mountain pass safety alerts, acclimatization pacing, and responsible travel choices.",
      ...
      plan_btn_generate: "⚡ Generate Safety-Audited Tour Plan",
      plan_empty_title: "Safety-Audited Dynamic Route",
      plan_empty_sub: "Fill out the expedition parameters on the left to compute a live tour plan audited against real-time mountain pass telemetry and AMS acclimatization pacing.",
    ...
    hi: {
      ...
      nav_map: "मानचित्र",
      nav_planner: "टूर प्लानर",
      nav_ai: "भारत AI",
      nav_responsible: "इको ट्रैवल",
      nav_culture: "संस्कृति",
      nav_food: "व्यंजन",
      nav_search: "खोजें",
      nav_help_sos: "🆘 सहायता (Help)",
      ...
      map_panel_desc: "नक्शे पर किसी भी मार्कर पर कर्सर ले जाकर कार्ड देखें, या पूर्ण विवरण देखने और सीधे टूर प्लानर से जुड़ने के लिए क्लिक करें।",
      ...
      ai_title: "आपका बुद्धिमान अखिल भारतीय यात्रा मार्गदर्शक।",
      ai_sub: "संपूर्ण भारत के लिए रीयल-टाइम AI — कोलकाता की धरोहर से लेकर राजस्थान के किलों, केरल के बैकवाटर्स और हिमालयी दर्रों तक।",
      sug_kolkata: "कोलकाता धरोहर",
      sug_jaipur: "जयपुर आकर्षण",
      ...
      ai_bot_status: "भारत AI • सक्रिय",
      ai_welcome: "नमस्ते! 🙏 मैं भारत एआई (Bharat AI) हूँ — संपूर्ण भारत यात्रा के लिए आपका बुद्धिमान मार्गदर्शक। मुझसे कोलकाता, राजस्थान, केरल, हिमालय, स्थानीय भोजन, होमस्टे या यात्रा योजना के बारे में कुछ भी पूछें!",
      ai_input_placeholder: "भारत AI से गंतव्य, मार्ग, भोजन, संस्कृति के बारे में पूछें...",
      ai_send: "भेजें →",

      // Planner
      plan_eyebrow: "स्मार्ट टूर प्लानर",
      plan_title: "दिनों को सुनहरी यादों में बदलें।",
      plan_sub: "लाइव दर्रा सुरक्षा अलर्ट, ऊंचाई अनुकूलन और जिम्मेदार यात्रा विकल्पों को ध्यान में रखकर तैयार की जाने वाली टूर योजना।",
      ...
      plan_btn_generate: "⚡ सुरक्षा-समीक्षित टूर प्लान बनाएं",
      plan_empty_title: "सुरक्षा-समीक्षित गतिशील मार्ग",
      plan_empty_sub: "वास्तविक समय के दर्रा डेटा और ऊंचाई अनुकूलन के आधार पर एक लाइव टूर प्लान तैयार करने के लिए बाईं ओर पैरामीटर भरें।",
      ...
      drawer_plan: "कस्टम टूर प्लान करें →",
    ...
    bn: {
      ...
      map_panel_desc: "মানচিত্রের যেকোনো মার্কারে কার্সার রেখে কার্ড দেখুন, অথবা সম্পূর্ণ তথ্য জানতে এবং সরাসরি ট্যুর প্ল্যানারের সাথে যুক্ত হতে ক্লিক করুন।",
      ...
      ai_title: "আপনার বুদ্ধিমান সর্বভারতীয় ভ্রমণ সহায়ক।",
      ai_sub: "সমগ্র ভারতের জন্য রিয়েল-টাইম AI — কলকাতার সংস্কৃতি থেকে রাজস্থানের দুর্গ, কেরলের ব্যাকওয়াটার্স ও হিমালয়ের গিরিপথ পর্যন্ত।",
      sug_kolkata: "কলকাতা ঐতিহ্য",
      sug_jaipur: "জয়পুর দর্শন",
      ...
      ai_bot_status: "ভারত AI • সক্রিয়",
      ai_welcome: "নমস্কার! 🙏 আমি ভারত এআই (Bharat AI) — সমগ্র ভারত ভ্রমণের জন্য আপনার বুদ্ধিমান সহায়ক। কলকাতা, রাজস্থান, কেরল, হিমালয়, স্থানীয় খাবার, হোমস্টে বা ভ্রমণ পরিকল্পনা সম্পর্কে যেকোনো প্রশ্ন করুন!",
      ai_input_placeholder: "ভারত AI কে গন্তব্য, রুট, খাবার, সংস্কৃতি সম্পর্কে জিজ্ঞাসা করুন...",
      ai_send: "পাঠান →",

      // Planner
      plan_eyebrow: "স্মার্ট ট্যুর প্ল্যানার",
      plan_title: "দিনগুলোকে আজীবন স্মৃতিতে রূপ দিন।",
      plan_sub: "লাইভ গিরিপথ সতর্কতা, উচ্চতা অভিযোজন এবং দায়িত্বশীল ভ্রমণ পছন্দের ভিত্তিতে তৈরি এআই-পর্যালোচিত ট্যুর প্ল্যান।",
      ...
      plan_btn_generate: "⚡ নিরাপদ ট্যুর প্ল্যান তৈরি করুন",
      plan_empty_title: "নিরাপদ গতিশীল ভ্রমণপথ",
      plan_empty_sub: "রিয়েল-টাইম গিরিপথের অবস্থা এবং উচ্চতা অভিযোজনের ভিত্তিতে ট্যুর প্ল্যান তৈরি করতে বাঁদিকের ফর্মটি পূরণ করুন।",
      ...
      drawer_plan: "কাস্টম ট্যুর প্ল্যান তৈরি করুন →",
